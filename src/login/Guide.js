...
export default function Guide() {
    return (
        ...
        <h1>Guide</h1>
          <Row md={3}>
            <Col><h5>Login Screen:</h5>
            <p>Users can login through Google OAuth and navigate to our 
               landing page through the nav bar on top by clicking on the 
               corresponding sections they choose to view.</p></Col>
            <Col ><h5>Home Screen:</h5>
            <p> Users can do various things on our home screen. It includes of 3 main buttons, 
            ...
            <Col><h5>Main Game:</h5>
            <p>Users are introduced with a prompt, chart, input box, and a timer. Once the user starts 
